...
MAP_DATA_LOOKUP:  
		...
		;	defb $08,$AD,$83,$AD,$FB,$AD
	;	defb $79,$AE,$D2,$AE,$40,$AF,$CD,$AF
		;	defb $37,$B0,$C6,$B0,$45,$B1,$B8,$B1
;			defb $2D,$B2
			;defb $86,$B2
		;	defb $DA,$B2,$5B,$B3
		;	defb $D8,$B3
;			defb $4C,$B4,$C4,$B4,$22,$B5
		;	defb $8F,$B5
		; defb $06,$B6,$99,$B6,$9C,$B6
		;	defb $16,$B7,$8B,$B7,$DA,$B7,$11,$B8
		;	defb $4F,$B8,$C0,$B8,$28,$B9,$91,$B9
			defb $FF		
			defb $B9,$62,$BA,$C9,$BA,$1D,$BB,$86		
			defb $BB,$18,$BC,$76,$BC,$D7,$BC,$3D		
			defb $BD,$C9,$BD,$33,$BE,$B4,$BE,$16		
			defb $BF,$5E,$BF,$CC,$BF,$3C,$C0,$AB		
			defb $C0,$05,$C1,$A5,$C1,$45,$C2,$AC		
			defb $C2,$FD,$C2,$75,$C3,$91				
			defb $77    								
...
RESET_FOR_NEXT_SCREEN:		
	...
	;	LD (LEVEL_OFFSET),a
		...
		;	LD A,$4A	; end lift level
			...
			LD BC,MAP_DATA_LOOKUP			; $7266 ; Offset
