...
SPAWN_LANE_GUARDIANS:  
			...
			INC HL						; $900C
			LD A,(HL)					; $900D  ; 
			LD (IX+$0A),A				; $900E	 ; Direction ($FF=up, $01=down)
...
GUARDIAN_INIT:							; $9030
			...
			defb $3C,$FF	;   Y offset, Direction ($FF=up, $01=down)			
			defb $37,$FF		
			defb $32,$FF
			defb $2D,$FF
			defb $3C,$01
