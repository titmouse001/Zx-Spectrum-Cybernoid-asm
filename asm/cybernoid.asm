...
;------------------------------------------------------------------
			...
			; Note: Section ($6103-$6503) is in a range for clearing early at startup
			defb $3E										; $6103
...
GO_25FPS:	XOR A					; $6574  ; frame count is a byte - reset 
			...
			CALL L_7CD2				; $6593		; move player bombs (rockets)
			...
			CALL L_97F0				; $65C3		; move scenes Missiles
			CALL L_970F				; $65C6
